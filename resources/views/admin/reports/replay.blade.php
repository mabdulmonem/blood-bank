...
@section('content')
    ...
    <!-- /.col -->
    <div class="col-md-12">
        <form action="{{ admin_url("replay/report/$report->id") }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card card-primary card-outline">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ admin_url("reports/$report->id") }}" class="btn btn-default float-right"><i class="fas fa-times"></i> إالغاء</a>
                </div>
                <!-- /.card-footer -->
            </div>
            <!-- /.card -->
